//////////////////////////////////////////// 
// xyzzytext2 v2.1 Script (Set Line Color) by Huney Jewell
// xyzzytext2 v2.0 Script (5 Face, Single Texture) 
//
...
/////////////// CONSTANTS /////////////////// 
// XyText Message Map. 
integer DISPLAY_STRING      = 304000; 
integer DISPLAY_EXTENDED    = 304001; 
integer REMAP_INDICES       = 304002; 
integer RESET_INDICES       = 304003; 
integer SET_FADE_OPTIONS    = 304004; 
integer SET_FONT_TEXTURE    = 304005; 
integer SET_LINE_COLOR      = 304006; 
integer SET_COLOR           = 304007; 
integer RESCAN_LINKSET      = 304008;
...
init()
{
    ...
    @loop;
    {
        ...
        for(x=0;x<=num_prims;++x)
        {
            ...
            if(llList2String(tmp,0) == "xyzzytext2")
            {
