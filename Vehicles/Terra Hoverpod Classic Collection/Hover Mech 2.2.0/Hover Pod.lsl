// Hover Pod script adapted from the Linden Lab hover board script by Lola Bombay and Cubey Terra.
// Cannon control added by Oedefe Silverman
...
float HOVER_HEIGHT = 15.0;       //  How high to hover while flying
...
integer next_cannon = 0;

fire()
{
    llMessageLinked(LINK_ALL_OTHERS, next_cannon, "fire cannon", NULL_KEY);
    next_cannon = 1 - next_cannon;
}
...
default
{
    ...
    touch_start(integer num)
    {
        ...
        {
           llWhisper(0, "Created by Cubey Terra, Mocha (200, 100)."); 
