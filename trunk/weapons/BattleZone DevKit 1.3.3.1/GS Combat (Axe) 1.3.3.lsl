...
//
// This is the script you should put into a axe, or melee weapon.
...
hit(string type, string anim, string sound)
{
    ...
    // Timing is important. Based on kick, punch, and axe attack-types, these
...
default
{
    ...
    attach(key agent)
    {
        ...
        if (agent == NULL_KEY && ready) llWhisper(hChannel, "sheathed axe");
    }
    ...
    control(key id, integer held, integer change) {
        ...
        if (down & (CONTROL_ML_LBUTTON | CONTROL_LBUTTON))
        {
            ...
            if (pressed  & CONTROL_FWD)                                 hit("axe", "sword_strike_R", "");
    ...
    sensor(integer tnum)
    {
        ...
        if (strike == "axe")        llPlaySound("9850f8df-c86a-80d9-eca7-d6f12aae6f9e", 1);
