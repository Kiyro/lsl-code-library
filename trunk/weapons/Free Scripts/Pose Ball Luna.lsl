...
string ANIMATION="lay004";             //Put the name of the pose/animation here!
vector offset=<.5,0,.5>;            //You can play with these numbers to adjust how far the person sits from the ball. ( <X,Y,Z> )
