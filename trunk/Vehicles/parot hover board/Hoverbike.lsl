...
string note_name = "ALS Delphinus Hoverbike 1000";
...
default
{
    state_entry()
    {
       ...
       mass = llGetMass();
//////////////////////////////////       
       llSitTarget(<0.5, 0.053, 0.21>, <0,0,0,1>);                //  Set seating location. Change for different height AVs
    ...
    changed(integer change)
    {
      ...
      //  Help you off the bike 
           ...
           {
               llSay(0, "Please step away from the hoverbike.");
               llUnSit(avatar);
           }
        }
    }
