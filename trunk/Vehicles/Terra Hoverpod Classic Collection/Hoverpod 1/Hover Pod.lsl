// Hover Pod script adapted from the Linden Lab hover board script. Modified by Lola Bombay and Cubey Terra.
...
default
{
    state_entry()
    {
       ...
       llSetCameraEyeOffset(<-16.0, 0.0, 2.0>);
       llSetSitText("Ride");
       llSetCameraAtOffset(<0, 0.0, 2>);
