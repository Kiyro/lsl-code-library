...
// THIS SCRIPT IS NOT FOR USE IN ANY OTHER VEHICLE.
 
// IT IS PROVIDED FOR FREE WITH CUBEY TERRA'S FREE MINI HOVERPOD 2.0.2
// NOT FOR RESALE. IF YOU FIND THIS SCRIPT IN ANY OTHER VEHICLE, PLEASE CONTACT CUBEY TERRA.
...
float HOVER_HEIGHT = 3.0;       //  How high to hover while flying
...
default
{
    ...
    run_time_permissions(integer perms)
    {
        if(perms & (PERMISSION_TAKE_CONTROLS))
        {
            ...
            llWhisper(0, "Use arrow keys to drive. Press PgUp to jump. Press PgDown to brake.");
