...
vector startSize = <2.00,2.00,2.00>;     // Start size of particles 
vector endSize = <0.20,0.20,0.20>;       // End size of particles (if interpSize == TRUE)
vector push = <0,0,0>;          // Force pushed on particles

// System paramaters
float rate = 15;            // How fast (rate) to emit particles
