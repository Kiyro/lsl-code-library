...
float accuracy =        0.0;
    // How the bullets will spread out as they move. 0.01 is almost nothing, 10 is HUGE.
    // Reccommend .05 to 5
    // The bigger rez_spread, the more effect this number has.
    // LOWER is more accurate.
    
float rez_spread =      0.0;
    // How the bullets will be spread out as they rez.
    // You need about 0.075 per "rez slave" script to minimize bullet collisions.
    
vector rez_offset =     <2,0,0>;
