...
default
{
    state_entry()
    {
        ...
        llSetCameraEyeOffset(<-18.0, 0.0, 7.0>);
        llSetSitText("Pilot");
        llSetCameraAtOffset(<0, 0.0, 0>);
        llWhisper(0,"Deactivated ... Security conditions set. Type /6 menu for a list of options.");
