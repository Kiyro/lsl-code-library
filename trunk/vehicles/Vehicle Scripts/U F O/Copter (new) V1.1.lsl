...
stuntparams()
{
    llSitTarget(<0.5, 0.0, 0.6>, <0,0,0,1>); 
    llSetSitText("Fly");
    llSetCameraEyeOffset(<-20.0, 0.0, 5.0>);
    ...
    llSetVehicleFloatParam( VEHICLE_LINEAR_MOTOR_TIMESCALE, 1.2 );
    llSetVehicleFloatParam( VEHICLE_LINEAR_MOTOR_DECAY_TIMESCALE, 3 );
    
    // angular motor 
    llSetVehicleVectorParam( VEHICLE_ANGULAR_MOTOR_DIRECTION, <0, 0, 0> );
    llSetVehicleFloatParam( VEHICLE_ANGULAR_MOTOR_TIMESCALE, 1.2 );
    ...
    // banking
    llSetVehicleFloatParam( VEHICLE_BANKING_EFFICIENCY, .05 );//0
    llSetVehicleFloatParam( VEHICLE_BANKING_MIX, 0 );//0
    llSetVehicleFloatParam( VEHICLE_BANKING_TIMESCALE, .01 );//1000
